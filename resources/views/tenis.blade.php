...
<div class="interaction-bar-left">
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="{{ url('/Tenis') }}"style="background-color: pink; color: black;">Tenis</a>
        </div>
    </div>
    ...
    <form id="formularioCompra">
        ...
        <div>
            ...
            <input type="text" id="nombre" name="nombre" 
                ...
                title="Solamente Nombre(s) y apellidos."
                required>
        </div>
        <div>
            ...
            <input type="text" id="direccion" name="direccion" 
                ...
                title="La dirección solo puede contener letras, números y espacios."
                required>
        </div>
        <div>
        ...
        @else
            <button id="botonIniciarSesion" type="button" onclick="window.location.href='{{ route('login') }}'">Iniciar Sesión</button>
        @endauth
